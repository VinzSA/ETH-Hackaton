...
export const demoDocuments: { title: string; text: string }[] = [
  {
    ...
    text: "67-year-old male arrives at 2 AM after mechanical fall at home with right hip fracture, confused, GCS 13, unable to provide reliable history. Scheduled for emergency hip fracture ORIF. Past history per chart includes atrial fibrillation. Family reports a known penicillin allergy with rash.",
  },
  {
